...
from multiwormtracker.defaults import DEFAULTS
...
class AddJob(tk.Toplevel):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.widgets['keep_dead_method'] = method
